...
export default class HistoryTopUp extends Component {
  render() {
    return (
      <Container>
        ...
        <View span style={{backgroundColor: '#1D90F8', height: 150, flexDirection: 'row'}}>
          ...
          <Body style={{marginLeft: -25}}>
            <H2 style={{color: 'white', width: 250, fontWeight: 'bold'}}>History Top Up Anda</H2>
          </Body>
          <Right />
        </View>
          <Text>{"\n"}</Text>
          <H3 style={{marginLeft: 30, fontWeight: 'bold', color: '#30353C'}}>Tanggal{"\n"}</H3>
          <View style={{flexDirection: 'row', justifyContent: 'space-around'}}>
            ...
            <H3 style={{fontWeight: 'bold', marginLeft: 30, marginTop: 30, color: '#30353C', marginBottom: 15}}>Pengeluaran</H3>
          <Card style={{marginLeft:30,marginRight:30}}>
            <CardItem style={{backgroundColor: '#FB8D97'}}>
              <Left>
                <View style={{marginTop: 13}}>
                  <Text style={{color: "white", fontWeight: 'bold', fontSize: 18}}>Total Top Up</Text>
          ...
          <View style={{marginTop: 40, marginLeft: 30}}>
            <H3 style={{fontWeight: 'bold', marginBottom: 15, color: '#30353C'}}>Catatan Top Up</H3>
          </View>
          <Card style={{marginLeft:30,marginRight:30}}>
            <CardItem>
              <Left>
                <View>
                  <Text style={{fontWeight: 'bold', color: '#30353C'}}>Top Up</Text>
              ...
              <Right>
                <View>
                  <Text style={{color: '#52D8A2', width: 150, textAlign: 'right'}}>+Rp. 600.000</Text>
          ...
          <Card style={{marginLeft:30,marginRight:30}}>
            <CardItem>
              ...
              <Right>
                <View>
                  <Text style={{color: '#52D8A2', width: 150, textAlign: 'right'}}>+Rp. 430.000</Text>
          ...
          <Card style={{marginLeft:30,marginRight:30}}>
            <CardItem>
              ...
              <Right>
                <View>
                  <Text style={{color: '#52D8A2', width: 150, textAlign: 'right'}}>+Rp. 870.000</Text>
          ...
          <Card style={{marginLeft:30,marginRight:30, marginBottom: 30}}>
            <CardItem>
              ...
              <Right>
                <View>
                  <Text style={{color: '#52D8A2', width: 150, textAlign: 'right'}}>+Rp. 900.000</Text>
